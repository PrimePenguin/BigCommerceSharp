...
namespace BigCommerceSharp.Api
{
    ...
    /// </summary>
    public interface IProductOptionsApi
    {
        /// <summary>
        ...
        OptionResponse CreateOption (int? productId, object option, string accept, string contentType);
        /// <summary>
        ...
        OptionResponse1 GetOptionById (int? productId, int? optionId, string contentType, string accept, string includeFields, string excludeFields);
        /// <summary>
        ...
        OptionCollectionResponse GetOptions (int? productId, int? page, int? limit, string includeFields, string excludeFields);
        /// <summary>
        ...
        OptionResponse2 UpdateOption (int? productId, int? optionId, object option, string accept, string contentType);
    }
  
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class ProductOptionsApi : IProductOptionsApi
    {
        /// <summary>
