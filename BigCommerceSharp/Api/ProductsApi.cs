...
namespace BigCommerceSharp.Api
{
    ...
    public class ProductsApi
    {
        ...
        public ProductResponse CreateProduct(ProductBase1 product, string includeFields)
        {
        ...
        /// <returns>ProductResponse</returns>
        public ProductResponse GetProductById(int? productId, string include = null, string includeFields = null, string excludeFields = null, int? priceListId = null)
        {
        ...
        public InlineResponse200 GetProducts(int? id = null, string name = null, string sku = null, string upc = null, decimal? price = null, decimal? weight = null, string condition = null, int? brandId = null, string dateModified = null, string dateLastImported = null, bool? isVisible = null, int? isFeatured = null, int? isFreeShipping = null, int? inventoryLevel = null, int? inventoryLow = null, int? outOfStock = null, int? totalSold = null, string type = null, int? categories = null, string keyword = null, string keywordContext = null, int? status = null, string include = null, string includeFields = null, string excludeFields = null, string availability = null, int? priceListId = null, int? page = null, int? limit = null, string direction = null, string sort = null)
        {
        ...
        /// <param name="includeFields">Fields to include, in a comma-separated list. The ID and the specified fields will be returned.</param>
        /// <returns>ProductResponse</returns>
        public ProductResponse UpdateProduct(int? productId, object product, string includeFields)
        {
