...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IOrderRefundsApi
    {
        /// <summary>
        ...
        InlineResponse200 Getorderrefunds (string orderId, string accept, string contentType);
        /// <summary>
        ...
        /// <returns>InlineResponse200</returns>
        InlineResponse200 Getrefunds (List<int?> orderIdin, List<int?> idin, string accept, string contentType, DateTime? createdmin, DateTime? createdmax);
        /// <summary>
        ...
        InlineResponse2011 Postrefund (int? orderId, RefundRequest body, string accept, string contentType);
        /// <summary>
        ...
        InlineResponse201 Postrefundquote (int? orderId, RefundQuoteRequest body, string accept, string contentType);
    }
  
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class OrderRefundsApi : IOrderRefundsApi
    {
        /// <summary>
