...
namespace BigCommerceSharp.Api
{
    ...
    public class CatalogApi
    {
        ...
        /// <returns></returns>
        public void DeleteProducts(string name, string sku, decimal? price, decimal? weight, string condition, int? brandId, DateTime? dateModified, DateTime? dateLastImported, bool? isVisible, int? isFeatured, int? inventoryLevel, int? totalSold, string type, int? categories, string keyword)
        {
        ...
        public VariantCollectionResponse UpdateVariantsBatch(List<object> body)
        {
